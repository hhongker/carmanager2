	  ...
	  <div class="col-md-offset-3 col-md-6 col-sm-12">
		 ...
		 <form class="form-horizontal" action="" method="post">
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="username" class="form-control" id="loginname" placeholder="姓名">
			</div>
		  </div>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="password" name="password" class="form-control" id="loginpwd" placeholder="请输入登陆密码">
